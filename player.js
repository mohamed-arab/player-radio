...
class myplayer{
    ...
    player_play_pause(){
        if(this.isplayer == false){
            this.buttons_play_pause.src="pause.png";
            this.my_music.play();
            this.isplayer =true;
        }
        else{
            this.buttons_play_pause.src="play.png";
            this.my_music.pause();
            this.isplayer=false;
        }
    }
...
class background_images{
    ...
    change_photo(photos){
     if(photos =="photo1"){
        document.body.style.backgroundImage="url(music_image1.jpg)";
     }
     else if(photos =="photo2"){
        document.body.style.backgroundImage="url(music_image2.jpg)";
     }
     else if(photos =="photo3"){
        document.body.style.backgroundImage="url(music_image3.jpg)";
     }
     else if(photos =="photo4"){
        document.body.style.backgroundImage="url(music_image4.jpg)";
     }
     else if(photos =="photo"){
        document.body.style.backgroundImage="url(music_image.jpg)";
     }
